...
module.exports = exports = function(webot){
  ...
  require('js-yaml');//解析
  webot.dialog(__dirname + '/dialog.yaml');//加载文件具体为止
  ...
  webot.set('search', {
    ...
    webot.set('课表', {
        ...
        handler: function(info){
            var kebiao =
            {
                type: 'image',
                title: '课表',
                mediaId: 'xpzm_1N8cIHVp10sUHRwyRB1FBimJMbZr7KyBtAFVJgtrZMRlD2uBf_sJzS7QOTO',
                description: '北大软微课表',}
            return kebiao;
        }
    });
    ...
    webot.set('食堂几点开门', {
        ...
        pattern: /[(食|饭堂)|(餐厅)(几点)|(什么时候)|(何时)(开|关(门)?)|(开始|饭)]|[几点(能)?开|吃饭]]|[(食|饭堂)|(餐厅)开|关门时间]]/,
